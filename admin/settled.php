...
check_login();
$_SESSION['msg']=" ";
$q=$con->prepare("select id,client_name,borrower,amount,profit,total,loan_stat,duration_from,duration_to,date_issued from loan where loan_stat=1 order by id desc");
$q->execute();
$q->store_result();
?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<title>Admin | Settled  Loan History</title>
		<meta charset="utf-8" />
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin  | Settled Loan History</h1>
																	</div>
								...
								?></span>
									...
									<li class="active">
										<span>Settled Loan History</span>
									</li>
								</ol>
							</div>
						</section>
