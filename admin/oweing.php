...
check_login();
$_SESSION['msg']=" ";
$q=$con->prepare("select id,client_name,borrower,amount,profit,total,loan_stat,duration_from,duration_to,date_issued from loan where loan_stat=0 order by id desc");
$q->execute();
$q->store_result();
?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<title>Admin | Debt History</title>
		<meta charset="utf-8" />
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin  | Debt History</h1>
																	</div>
...
if($diff==3){
echo "<script>
alert('3 days remaining for $n loan to expire');
</script>";	
}
elseif($diff==2){
echo "<script>
alert('2 days remaining for $n loan to expire');
</script>";	
}
elseif($diff==1){
echo "<script>
alert('1 day remaining for $n loan to expire');
</script>";		
}
...
elseif($cur>$exp){
	//$n="date expired";
echo "Oweing for ".$diff." days";	
echo "<script>
alert(' $n is Oweing for $diff days');
</script>";	
...
echo $diff." days remaining ";
	echo "<script>
alert('$n loan has expired today');
</script>";	
}
