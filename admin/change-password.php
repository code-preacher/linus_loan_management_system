...
if(isset($_POST['submit']))
{
	$cpass=$_POST['cpass'];
	$npass=$_POST['npass'];
$sql=mysqli_query($con,"SELECT password,username FROM  admin where password='$cpass' ");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($con,"update admin set password='$npass' where username='".$num['username']."' ");
$_SESSION['msg1']="Password Changed Successfully !!";
}
else
{
$_SESSION['msg2']="Old Password Do not match !!";
}
}
?>
<!DOCTYPE html>
