...
$q=$con->prepare("insert into loan(client_name,borrower,amount,profit,total,loan_stat,duration_from,duration_to,date_issued) values(? , ? , ? , ? , ? , ? , ?, ?,?)");
$q->bind_param('ssiiiisss',$cname,$bname,$amount,$profit,$total,$loan_stat,$durationf,$durationt,$date);
$q->execute();


if($q){
$_SESSION['msg2']="Loan Issued Successfully !!!";
}
else
{
$_SESSION['msg1']="Loan Issueing Failed !!!";
}
}
?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<title>Admin  | Loan Issueing</title>
		<meta charset="utf-8" />
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin | Issue Loan</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Issue Loan</h5>
												</div>
...
$bid=$con->prepare("select name from client order by id desc");
$bid->execute();
$bid->store_result();
$bid->bind_result($nm);
								 ?>
					...
					<input type="text" name="bname" class="form-control"  placeholder="Enter Borrower Name">
														</div>
														<div class="form-group">
															<label for="exampleInputPassword1">
															Amount
