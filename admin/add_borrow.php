...
$q=$con->prepare("insert into manager(cashier_id,password,fullname,sex,shop,date) values(? , ? , ? , ? , ? , ? )");
$q->bind_param('ssssss',$cashierid,$password,$name,$sex,$shop,$date);
$q->execute();

$lg=$con->prepare("insert into manager_log(cashier_id,name,userip,status,login_time,logout_time) values(? , ? , ? , ? , ? , ? )");
$lg->bind_param('ssssss',$cashierid,$name,$ip,$st,$lt,$lo);
$lg->execute();

if($q){
$_SESSION['msg2']="Manager Added Successfully !!!";
}
else
{
$_SESSION['msg1']="Manager failed inserting !!!";
}
}
?>
<!DOCTYPE html>
...
function valid()
{
if(document.chngpwd.cashierid.value=="")
{
alert("Bet Id Field is Empty !!");
document.chngpwd.cashierid.focus();
return false;
}
...
else if(document.chngpwd.name.value=="")
{
alert("Name Field is Empty !!");
...
else if(document.chngpwd.shop.value=="")
{
alert("Name Field is Empty !!");
document.chngpwd.shop.focus();
return false;
}else if(document.chngpwd.sex.value=="")
{
alert("Name Field is Empty !!");
document.chngpwd.sex.focus();
return false;
}
return true;
}
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin | Add Manager</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Add Manager</h5>
												</div>
					...
					<input type="text" name="cashierid" class="form-control"  placeholder="Enter Cashier Id">
														</div>
